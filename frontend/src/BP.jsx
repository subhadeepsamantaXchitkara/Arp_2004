...
const playlist = [
  { id: 1, title: "Sooraj Dooba Hain", artist: "Arijit Singh", src: song1 },
  { id: 2, title: "Gulbahar", artist: "Ishaan & Shuvendu Das", src: song2 },
  { id: 3, title: "Hawayein", artist: "Arijit Singh", src: song3 },
  { id: 4, title: "Pherari mon", artist: "Shreya Ghoshal", src: song4 },
  { id: 5, title: "Ek Pyar Ka Nagma Hai", artist: "Papon, Neeti Mohan", src: song5 },
  { id: 6, title: "Aankhon Mein Doob Jaane Ko", artist: " THE 9TEEN, Sandesh Shandilya", src: song6 },
  { id: 7, title: "Jiya Tui Chara", artist: "Arijit Singh", src: song7 },
  { id: 8, title: "Keno Roder Moto Hashle Na", artist: "Mekhla Dasgupta", src: song8 },
  { id: 9, title: "Uthche Jege Sokalgulo", artist: "Shreya Ghoshal", src: song9 },
  { id: 10, title: "Piya Tose Naina Lage Re", artist: "Jonita Gandhi", src: song10 },
];
    ...
    <div className="birthday-container">
      ...
      <section className="message-section">
        ...
        <div className="message-content">
          <p>
           🎉✨ Hey Arpita, it's your day! ✨
Another orbit completed around the sun, another year of your light brightening the world. Today truly belongs to you — may all the happiness in the world find its way to your heart.🙌 </p>
          <p>
           In my life, you’re more than just a person… more than a friend. You’ve become one of the keys to my happiness — the reason behind so many of my smiles, thoughts, and feelings.
So, if somehow my little effort today brings even a tiny smile to your face, that’s all I could ever wish for. 🌸
Once again, Happy Birthday — may your world stay as beautiful as your presence makes mine. 🩵🤍💫 </p>
        </div>
      </section>
